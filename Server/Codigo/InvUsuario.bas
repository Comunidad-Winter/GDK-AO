...
Select Case Obj.OBJType
    Case eOBJType.otWeapon
        ...
        UserList(UserIndex).Char.AuraAngle = 0
        Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "AGA" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.AuraAngle)
    ...
    Case eOBJType.otWeapon
       If ClasePuedeUsarItem(UserIndex, ObjIndex) And _
          FaccionPuedeUsarItem(UserIndex, ObjIndex) Then
                ...
                Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CLA" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aura)
                UserList(UserIndex).Char.AuraAngle = Obj.AuraAngle
                Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "AGA" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.AuraAngle)
