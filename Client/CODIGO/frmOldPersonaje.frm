...
NameTxt.Text = ""
PasswordTxt.Text = ""
Me.Picture = LoadPicture(DirGraficos & "oldcaracter.jpg")
Image1(1).Picture = LoadPicture(DirGraficos & "bvolver.jpg")
Image1(0).Picture = LoadPicture(DirGraficos & "bsiguiente.jpg")
Image1(2).Picture = LoadPicture(DirGraficos & "bteclas.jpg")
...
Select Case Index
    Case 0
        If Image1(0).Tag = "0" Then
            ...
            Image1(0).Picture = LoadPicture(DirGraficos & "bsiguientea.jpg")
        End If
    Case 1
        If Image1(1).Tag = "0" Then
            ...
            Image1(1).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(1).Picture = LoadPicture(DirGraficos & "bvolvera.jpg")
        End If
    Case 2
        If Image1(2).Tag = "0" Then
            ...
            Image1(2).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(2).Picture = LoadPicture(DirGraficos & "bteclasa.jpg")
        End If
